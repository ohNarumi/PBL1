                ...
                <div class="Gap-top">
                    <div class="ko2">
                        ...
                        <div id="menu1" style="display:none;clear:both;">
                            ...
                            <input type="checkbox" id="scales" name="IoT"><label for="javascript">javascript</label>
                            <input type="checkbox" id="scales" name="IoT"><label for="flutter">flutter</label>
                        </div>

...
<head>
  ...
  <title>記事詳細画面-2</title>
</head>

<body>
  <div class="flex">
    <div class="container">
      <figure class="image"><img src="images/image_5.jpg" alt=""></figure>
      <!-- <p class="number">閲覧数:256件</p> -->
      <p class="date">最終更新日: 2022/5/1(日曜日)</p>
    </div>
    <div class="right">
      <h1 class="titles">毎日プログラミングし続けた結果</h1>
      <h2 class="titles">投稿者：　ソフトⅣ　鯖峰　三郎</h2>
      <p class="text">
        -----------------------------------------------------------------------------------------------------</p>
      <p class="text">
        -----------------------------------------------------------------------------------------------------</p>
  ...
  <div>
    <section class="tag">
        <ul>
            ...
            <li><a href="#"><span>タイピング</span></a></li>

...
<body>
  <div class="flex">
    <div class="container">
      <figure class="image"><img src="images/image_1.jpg" alt=""></figure>
      <!-- <p class="number">閲覧数:256件</p> -->
      <p class="date">最終更新日: 2022/4/15(金曜日)</p>
    </div>
    <div class="right">
      <h1 class="titles">macbook Air と macbook Pro の違い</h1>
      <h2 class="titles">投稿者：　ソフトⅣ　神戸　電太郎</h2>
      <p class="text">
        -----------------------------------------------------------------------------------------------------</p>
      <p class="text">
        -----------------------------------------------------------------------------------------------------</p>
  ...
  <div>
    <section class="tag">
        <ul>
            <li><a href="#"><span>パソコン</span></a></li>
            <li><a href="#"><span>mac</span></a></li>
            <li><a href="#"><span>デバイス</span></a></li>
  ...
  <div class="star-contents">
    <p>
      <i>閲覧数:256件 評価:4.0</i><span class="star5_rating" data-rate="4"></span>
    </p>
  </div>
  <!-- 回答（投稿者情報） -->
  ...
  <div class="box2">
    <div name="kaitou1_data" style="position:absolute; top:50px; left:60px;">
      ...
      <p>
        それはそれとして購入を希望している者としてはとても気になる内容の記事でとても勉強になりました。神戸電太郎さんはmacbookを使用していて不便だと感じたことはあるのでしょうか？
      </p>
      <p>
        もしお時間がありましたら不便だと感じた点についても知りたいです！！！！！！！！！
      </p>
    </div>
  </div>
  <!-- 回答2（投稿者情報） -->

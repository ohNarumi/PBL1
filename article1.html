...
<body>
  <div class="flex">
    <div class="container">
      <figure class="image"><img src="images/image_4.jpg" alt=""></figure>
      <!-- <p class="number">閲覧数:256件</p> -->
      <p class="date">最終更新日: 2022/4/22(金曜日)</p>
    </div>
    <div class="right">
      <h1 class="titles">エンジニアとして必要な考え方</h1>
      <h2 class="titles">投稿者：　ソフトⅣ　斉藤　太郎</h2>
      <p class="text">
        -----------------------------------------------------------------------------------------------------</p>
      <p class="text">
        -----------------------------------------------------------------------------------------------------</p>
  ...
  <div>
    <section class="tag">
        <ul>
            <li><a href="#"><span>エンジニア</span></a></li>
            <li><a href="#"><span>アプリ開発</span></a></li>
